...
macOS (arm64, x86_64). The Linux and Windows wheels include the CUDA device,
which activates when an NVIDIA driver is present. The macOS arm64 wheel
includes the Metal device.
